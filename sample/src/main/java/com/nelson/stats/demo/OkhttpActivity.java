            ...
            public void onClick(View view) {
                NetworkStatsManager.getTodayBytes(new LoadCallBack() {
                    ...
                    public void onSuccess(long bytes) {
                        Toast.makeText(OkhttpActivity.this, "bytes: " + bytes, Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(int errorCode, String errorMsg) {
                        Toast.makeText(OkhttpActivity.this, "错误： " + errorMsg, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void useRetrofit() {
        ...
        call.enqueue(new Callback<List<Contributor>>() {
            ...
            public void onFailure(Call<List<Contributor>> call, Throwable t) {
                Toast.makeText(OkhttpActivity.this, "请求失败，原因：" + t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
